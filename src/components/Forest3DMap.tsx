...
const Forest3DMap: React.FC = () => {
  ...
  const loadData = async () => {
    try {
      ...
      const tribalRegionLayers = TRIBAL_REGIONS.features.map((feature, index) => {
      ...
      >
        ...
        >
          ...
          <div style={{ 
            ...
            <div style={{ fontWeight: 'bold', marginBottom: '5px' }}>India Forest Coverage</div>
            <div style={{ display: 'flex', alignItems: 'center', margin: '3px 0' }}>
              <div style={{ width: '12px', height: '12px', backgroundColor: 'rgb(0,180,40)', marginRight: '5px' }}></div>
              <span>Forest Regions</span>
            </div>
            <div style={{ display: 'flex', alignItems: 'center', margin: '3px 0' }}>
              <div style={{ width: '12px', height: '12px', backgroundColor: 'rgb(255,200,0)', borderRadius: '50%', marginRight: '5px' }}></div>
